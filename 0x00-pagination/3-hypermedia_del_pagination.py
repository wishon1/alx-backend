        ...
        Returns:
            dict: A dictionary containing the following key-value pairs:
                ...
                - next_index (int): The index to use for the next page request. This
                  is the index of the first item after the last item on the current
                  page.
                - page_size (int): The current page size.
                - data (list): The actual items of the dataset for the current page.

        Behavior:
            - Uses assert to ensure that the provided index is within the valid range
              of the dataset.
            - If the user queries index 0 with page_size 10, they will receive items
              indexed from 0 to 9 inclusive.
            - If the user requests the next index (e.g., 10) with page_size 10, but
              certain rows (e.g., 3, 6, and 7) have been deleted, the user should
              still receive the items indexed from 10 to 19 inclusive, effectively
              skipping over the deleted items.
